...
4. For instance, the first burger will have namespace as burger_1 & third waffle_pi will have waffle_pi_3 as its namespace. 
...
- Update the params in this package according to your robot namespace : 
  ...
  ```bash
  cd ~/turtlebot3_ws/src/btp_pkg/src/
